...
public class UIManager : MonoBehaviour
{
    ...
    bool PlacedObject() => GameObject.FindGameObjectsWithTag("cat").Length > 0 || GameObject.FindGameObjectsWithTag("chicken").Length > 0 || GameObject.FindGameObjectsWithTag("dog").Length > 0 || GameObject.FindGameObjectsWithTag("lion").Length > 0 || GameObject.FindGameObjectsWithTag("penguin").Length > 0;
